...
- [Triplebyte](http://bit.ly/fem-triplebyte) is a really nice offering if you're looking for a new role. It's a free service that lets you take a confidential quiz. Based on your results companies will pitch you for their vacant roles!
   ...
   var ray1 = Output[2].languages;
    var ray2 = Output[2].tools;
    for (i=0; i<ray2.length; i++){
      if (!ray1.includes(ray2[i])){
        ray1.push(ray2[i]);
      }
    }
    console.log(ray1);
...
function filterArray(){
    if (!ray1.length == 0){
        for(i=0; i<ray1.length; i++){
            if(!mainArray.includes(ray1[i])){
                mainArray.push(ray1[i]);
            }
        }
    }
    else{
    ...
    if (!ray2.length == 0){
        for(i=0; i<ray2.length; i++){
            if(!mainArray.includes(ray2[i])){
                mainArray.push(ray2[i]);
            }
        }
    }
    else{
    ...
    if (!ray3.length == 0){
        for(i=0; i<ray3.length; i++){
            if(!mainArray.includes(ray3[i])){
                mainArray.push(ray3[i]);
            }
        }
    }
    else{
    ...
    if (!ray4.length == 0){
        for(i=0; i<ray4.length; i++){
            if(!mainArray.includes(ray4[i])){
                mainArray.push(ray4[i]);
            }
        }
    }
    else{
...
let newArray = liArray.filter(function(element){
    return elArray.includes(element);
